...
public class Level1 {
    ...
    N1F1PA3,N1F1PA6,N1F1PA7,N1F1PA8,N1F1PA9,N1F1INTERIOR, N1F1SUELO, N1F1BORDE_ABAJO,N1F1BORDE_ARRIBA,N1F1BORDE_DER,N1F1BORDE_IZQ, N1F1ESQ_IZQ_INF, 
    N1F1ESQ_IZQ_SUP, N1F1ESQ_DER_INF, N1F1ESQ_DER_SUP, N1F1PD, N1F1PL, N1F1PR ,N1F1PU, impresora, planta, trapeador,
    
    N1F2PA3, N1F2SUELO, N1F2BORDE_ABAJO,N1F2BORDE_ARRIBA,N1F2BORDE_DER,N1F2BORDE_IZQ, N1F2ESQ_IZQ_INF, 
    N1F2ESQ_IZQ_SUP, N1F2ESQ_DER_INF, N1F2ESQ_DER_SUP, latas,
    
    N1F3PA, N1F3BORDE_ABAJO,N1F3BORDE_ARRIBA,N1F3BORDE_DER,N1F3BORDE_IZQ, N1F3ESQ_IZQ_INF, N1F3ALFOMBRA ,
    N1F3ESQ_IZQ_SUP, N1F3ESQ_DER_INF, N1F3ESQ_DER_SUP, cajero;  
	...
	public void update(List<Structure> structures, int bloqueTam, int offsetX, int offsetY, boolean iPressed, Player player, List<Power_Up> powerups, List<Innocent> inocentes, List<Police> policias, List<Military> militares, List<Item> items, List<FloatingText> floatingText, List<Bomb> bombs) {			
		...
		if(Window.frameSeleccionado == 1) {
			...
			if(createObjects == 0) {
		    	 inocentes.add(new Innocent(bloqueTam * 5 + offsetX, bloqueTam * 1+ offsetY , bloqueTam, bloqueTam));
		    	 policias.add(new Police(bloqueTam * 8 + offsetX, bloqueTam * 1+ offsetY , bloqueTam, bloqueTam));
		    	 items.add(new Item(bloqueTam * 12 + offsetX, bloqueTam * 4+ offsetY , bloqueTam, bloqueTam, player,1));
		    	 items.add(new Item(bloqueTam * 1 + offsetX, bloqueTam * 8+ offsetY , bloqueTam, bloqueTam, player,1));
		    	 items.add(new Item(bloqueTam * 13 + offsetX, bloqueTam * 6+ offsetY , bloqueTam, bloqueTam, player,2));
		    	 items.add(new Item(bloqueTam * 13 + offsetX, bloqueTam * 2+ offsetY , bloqueTam, bloqueTam, player,2));
		    	 createObjects = 1;
			}
			...
			if(createObjects == 0) {
		    	 inocentes.add(new Innocent(bloqueTam * 12 + offsetX, bloqueTam * 1+ offsetY , bloqueTam, bloqueTam));
		    	 inocentes.add(new Innocent(bloqueTam * 3 + offsetX, bloqueTam * 7+ offsetY , bloqueTam, bloqueTam));
		    	 policias.add(new Police(bloqueTam * 6 + offsetX, bloqueTam * 1+ offsetY , bloqueTam, bloqueTam));
		    	 policias.add(new Police(bloqueTam * 2 + offsetX, bloqueTam * 5+ offsetY , bloqueTam, bloqueTam));
		    	 policias.add(new Police(bloqueTam * 9 + offsetX, bloqueTam * 7+ offsetY , bloqueTam, bloqueTam));
		    	 items.add(new Item(bloqueTam * 12 + offsetX, bloqueTam * 7+ offsetY , bloqueTam, bloqueTam, player,1));
		    	 items.add(new Item(bloqueTam * 5 + offsetX, bloqueTam * 3+ offsetY , bloqueTam, bloqueTam, player,2));
		    	 items.add(new Item(bloqueTam * 3 + offsetX, bloqueTam * 8+ offsetY , bloqueTam, bloqueTam, player,2));
		    	 items.add(new Item(bloqueTam * 13 + offsetX, bloqueTam * 4+ offsetY , bloqueTam, bloqueTam, player,2));
		    	 createObjects = 1;
			}
		    ...
		    structures.get(66).image = latas; 
				...
				if(createObjects == 0) {
			    	 militares.add(new Military(bloqueTam * 11 + offsetX, bloqueTam * 7+ offsetY , bloqueTam, bloqueTam));
			    	 policias.add(new Police(bloqueTam * 1 + offsetX, bloqueTam * 5+ offsetY , bloqueTam, bloqueTam));
			    	 policias.add(new Police(bloqueTam * 7 + offsetX, bloqueTam * 1+ offsetY , bloqueTam, bloqueTam));
			    	 policias.add(new Police(bloqueTam * 8 + offsetX, bloqueTam * 7+ offsetY , bloqueTam, bloqueTam));
			    	 inocentes.add(new Innocent(bloqueTam * 4 + offsetX, bloqueTam * 7+ offsetY , bloqueTam, bloqueTam));
			    	 inocentes.add(new Innocent(bloqueTam * 7 + offsetX, bloqueTam * 3+ offsetY , bloqueTam, bloqueTam));
			    	 items.add(new Item(bloqueTam * 2 + offsetX, bloqueTam * 5+ offsetY , bloqueTam, bloqueTam, player,2));
			    	 items.add(new Item(bloqueTam * 4 + offsetX, bloqueTam * 8+ offsetY , bloqueTam, bloqueTam, player,2));
			    	 items.add(new Item(bloqueTam * 9 + offsetX, bloqueTam * 8+ offsetY , bloqueTam, bloqueTam, player,2));
			    	 items.add(new Item(bloqueTam * 9 + offsetX, bloqueTam * 3+ offsetY , bloqueTam, bloqueTam, player,2));
			    	 items.add(new Item(bloqueTam * 13 + offsetX, bloqueTam * 2+ offsetY , bloqueTam, bloqueTam, player,2));
			    	 items.add(new Item(bloqueTam * 13 + offsetX, bloqueTam * 6+ offsetY , bloqueTam, bloqueTam, player,1));
		...
		if (Window.enemigosRestantes == 0 && Window.objetosRestantes == 0 && advanceFrame == 0) {
		    ...
		    new Thread(() -> {
		        ...
		        Iterator<Power_Up> iterator2 = powerups.iterator();
